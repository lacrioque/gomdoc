...
**YOU ARE IN: `gomdoc/polecats/keeper/`** — This is YOUR worktree. Stay here.
...
```bash
pwd  # Should show .../polecats/keeper
```
...
**Your mail address:** `gomdoc/polecats/keeper`
**Your rig:** gomdoc
...
1. Announce: "Polecat keeper, checking in."
